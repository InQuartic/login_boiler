...
exports.DEFAULT_ENUM_TYPE_BUILDER = (name, values) => `enum ${name} ${values}`;
...
exports.DEFAULT_DOCUMENTATION_GENERATOR = ({ description, tags = [] }) => (description || tags.length) ? `
  /**
   * ${util_1.filterAndJoinArray([fixDescriptionDocblock(description), ...tags.map(({ tag, value }) => `@${tag} ${value}`)], '\n* ')}
   */` : '';
